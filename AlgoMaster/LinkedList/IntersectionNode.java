...
public class IntersectionNode {
    ...
    public static void main(String[] args){
        ...
        ListNode intersectNode = linkedList.addNode(8);
        linkedList.addNode(4);
        linkedList.addNode(5);
        headA = linkedList.getHead();

        LinkedList linkedList2 = new LinkedList();
        linkedList2.addNode(5);
        linkedList2.addNode(6);
        ListNode temp = linkedList2.addNode(1);
        temp.next = intersectNode;

        headB = linkedList2.getHead();
        linkedList.printList(headA);
        System.out.println();
        linkedList2.printList(headB);

        ListNode intersectedNode  = getIntersectionNodeOptimized(headA,headB);
